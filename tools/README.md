...
The small CLIs the project will eventually need. Empty today — each lands as a separate PR with its own tests and package.json, and rejoins the pnpm workspace then.
