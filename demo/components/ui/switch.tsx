...
import { motion, uiMotionPressProps } from '@/components/ui/motion';
import { cn } from '@/lib/utils';

function Switch({ className, render, ...props }: SwitchPrimitive.Root.Props) {
  return (
    <SwitchPrimitive.Root
      ...
      data-slot="switch"
      nativeButton={!render}
      render={render ?? <motion.button {...uiMotionPressProps} />}
      {...props}
    >
